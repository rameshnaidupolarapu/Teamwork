...
class CoreAddressType
{
    ...
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("core_address_type");
            $registerController->setNodeNameData("core_address_type");
            $registerController->setDisplayValue("Address Type");
            ...
            $registerController->setRegisternodeId("core_address_type");           
            $registerController->setTablename("core_address_type");
