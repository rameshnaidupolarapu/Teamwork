...
class CoreNodeAttributeOptionList
{
    ...
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("core_node_attribute_option_list");
            $registerController->setNodeNameData("core_node_attribute_option_list");
            $registerController->setDisplayValue("Node Attribute Option List");
            ...
            $registerController->setRegisternodeId("core_node_attribute_option_list");           
            $registerController->setTablename("core_node_attribute_option_list");
            $registerController->setAutokey("id");
            $registerController->setPrimarykey("id");
            $registerController->setDescriptorkey("value");
            ...
            $registerController->setBoolattributes("is_default");
            ...
            $registerController->setSearch("short_code|value");
            ...
            $relationController->setCoreNodeSettingsId("core_node_attribute_option_list");
