...
class CoreWeekDetails
{
    ...
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("core_week_details");
            $registerController->setNodeNameData("core_week_details");
            $registerController->setDisplayValue("Week Details");
            ...
            $registerController->setRegisternodeId("core_week_details");           
            $registerController->setTablename("core_week_details");
