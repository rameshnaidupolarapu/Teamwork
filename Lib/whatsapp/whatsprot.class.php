...
require_once './lib/whatsapp/protocol.class.php';
require_once './lib/whatsapp/BinTreeNodeReader.php';
require_once './lib/whatsapp/BinTreeNodeWriter.php';
require_once './lib/whatsapp/Login.php';
require_once './lib/whatsapp/Logger.php';
require_once './lib/whatsapp/Constants.php';
require_once './lib/whatsapp/func.php';
require_once './lib/whatsapp/token.php';
require_once './lib/whatsapp/rc4.php';
require_once './lib/whatsapp/mediauploader.php';
require_once './lib/whatsapp/keystream.class.php';
require_once './lib/whatsapp/tokenmap.class.php';
require_once './lib/whatsapp/events/WhatsApiEventsManager.php';
require_once './lib/whatsapp/SqliteMessageStore.php';
require_once './lib/whatsapp/SqliteAxolotlStore.php';
require_once './lib/whatsapp/handlers/NotificationHandler.php';
require_once './lib/whatsapp/handlers/MessageHandler.php';
require_once './lib/whatsapp/handlers/IqHandler.php';
if (extension_loaded('curve25519') && extension_loaded('protobuf')) {
    require_once './lib/whatsapp/pb_wa_messages.php';
    require_once './lib/whatsapp/libaxolotl-php/util/KeyHelper.php';
    require_once './lib/whatsapp/libaxolotl-php/ecc/Curve.php';
    require_once './lib/whatsapp/libaxolotl-php/state/PreKeyRecord.php';
    require_once './lib/whatsapp/libaxolotl-php/state/PreKeyBundle.php';
    require_once './lib/whatsapp/libaxolotl-php/SessionBuilder.php';
    require_once './lib/whatsapp/libaxolotl-php/SessionCipher.php';
    require_once './lib/whatsapp/libaxolotl-php/groups/GroupCipher.php';
    require_once './lib/whatsapp/libaxolotl-php/groups/GroupSessionBuilder.php';
}
