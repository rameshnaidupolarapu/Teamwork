    ...
    public function execute()
    {
        ...
        {   
           $registerController=\CoreClass::getController("core_registernode", "core_developmentsettings");
            $registerController->setNodeFileName("taskmembertime");
            $registerController->setNodeNameData("taskmembertime");
            $registerController->setDisplayValue("TaskMemberTime");
            ...
            $registerController->setRegisternodeId("taskmembertime");           
            $registerController->setTablename("tw_task_member_time");
            $registerController->setAutokey("tw_task_member_time_id");
            $registerController->setPrimarykey("tw_task_member_time_id");
